SIF_plot <- function(filename){
  ...
  plot(data_diff_from_prev$'TipNr', data_diff_from_prev$'KI', main = paste("Difference in KI values from \nPrevious Step"), xlab = 'Tip Number', ylab= "Delta KI SIF Value", pch= pchvalue[data_diff_from_prev$'FractureNum'], col = colours[data_diff_from_prev$Step], cex = (data_diff_from_prev$'Step' + 4)/(num_of_steps+1))
  plot(data_diff_from_prev$'TipNr', data_diff_from_prev$'KII', main = paste("Difference in KII values from \nPrevious Step"), xlab = 'Tip Number', ylab= "Delta KII SIF Value", pch= pchvalue[data_diff_from_prev$'FractureNum'], col = colours[data_diff_from_prev$Step], cex = (data_diff_from_prev$'Step' + 4)/(num_of_steps+1))
  plot(data_diff_from_prev$'TipNr', data_diff_from_prev$'KIII', main = paste("Difference in KIII values from \nPrevious Step"), xlab = 'Tip Number', ylab= "Delta KIII SIF Value", pch= pchvalue[data_diff_from_prev$'FractureNum'], col = colours[data_diff_from_prev$Step], cex = (data_diff_from_prev$'Step' + 4)/(num_of_steps+1))
  plot(data_diff_from_prev$'TipNr', data_diff_from_prev$'G', main = paste("Difference in G values from \nPrevious Step"), xlab = 'Tip Number', ylab= "Delta G Value", pch= pchvalue[data_diff_from_prev$'FractureNum'], col = colours[data_diff_from_prev$Step], cex = (data_diff_from_prev$'Step' + 4)/(num_of_steps+1))
