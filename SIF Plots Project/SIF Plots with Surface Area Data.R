SIF_plot <- function(filename, SA_filename){
  ...
  # Raw data graphs.
  plot(data$'TipNr', data$'KI', main = paste("KI"), xlab = 'Tip Number', ylab= "KI SIF Value", pch= pchvalue[data$'FractureNum'], col = colours[data$Step + 1], cex = data$'SurfaceArea'/data$'MaxSurfaceArea')
  plot(data$'TipNr', data$'KII', main = paste("KII"), xlab = 'Tip Number', ylab= "KII SIF Value", pch= pchvalue[data$'FractureNum'], col = colours[data$Step + 1], cex = data$'SurfaceArea'/data$'MaxSurfaceArea')
  plot(data$'TipNr', data$'KIII', main = paste("KIII"), xlab = 'Tip Number', ylab= "KIII SIF Value", pch= pchvalue[data$'FractureNum'], col = colours[data$Step + 1], cex = data$'SurfaceArea'/data$'MaxSurfaceArea')
  plot(data$'TipNr', data$'G', main = paste("G"), xlab = 'Tip Number', ylab= "G Value", pch= pchvalue[data$'FractureNum'], col = colours[data$Step + 1], cex = data$'SurfaceArea'/data$'MaxSurfaceArea')
